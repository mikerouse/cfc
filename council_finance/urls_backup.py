...
# AI tools URLs are imported separately to avoid circular imports
...
urlpatterns = [
    ...
    # AI Tools Hub - Include from separate file to avoid circular imports
    path("", include("council_finance.urls_ai_tools")),
