...
urlpatterns = [
    ...
    path("lists/", follow_views.my_lists, name="my_lists"),
    path("lists/favourites/add/", follow_views.add_favourite, name="add_favourite"),
    path("lists/favourites/remove/", follow_views.remove_favourite, name="remove_favourite"),
    path("lists/<int:list_id>/add/", follow_views.add_to_list, name="add_to_list_api"),
    path("lists/<int:list_id>/remove/", follow_views.remove_from_list, name="remove_from_list_api"),
    path("lists/move/", follow_views.move_between_lists, name="move_between_lists"),
    path("lists/<int:list_id>/metric/", follow_views.list_metric, name="list_metric"),
    path("compare/add/<slug:slug>/", follow_views.add_to_compare, name="add_to_compare"),
    path("compare/remove/<slug:slug>/", follow_views.remove_from_compare, name="remove_from_compare"),
    path("compare/row/", follow_views.compare_row, name="compare_row"),
    path("compare/clear/", follow_views.clear_compare_basket, name="clear_compare_basket"),
    path("compare/", follow_views.compare_basket, name="compare_basket"),
    path("following/", follow_views.following, name="following"),
    # Enhanced Following System API Endpoints
    path("following/api/follow/", follow_views.follow_item_api, name="follow_item_api"),
    path("following/api/unfollow/", follow_views.unfollow_item_api, name="unfollow_item_api"),
    path("following/api/updates/<int:update_id>/interact/", follow_views.interact_with_update_api, name="interact_with_update_api"),
    path("following/api/updates/<int:update_id>/comment/", follow_views.comment_on_update_api, name="comment_on_update_api"),
    path("following/api/preferences/", follow_views.update_feed_preferences_api, name="update_feed_preferences_api"),
    path("following/api/updates/", follow_views.get_feed_updates_api, name="get_feed_updates_api"),
    # Legacy Following URLs (for backward compatibility)
    path("follow/<slug:slug>/", follow_views.follow_council, name="follow_council"),
    path("unfollow/<slug:slug>/", follow_views.unfollow_council, name="unfollow_council"),
    path("updates/<int:update_id>/like/", follow_views.like_update, name="like_update"),
    path("updates/<int:update_id>/comment/", follow_views.comment_update, name="comment_update"),
